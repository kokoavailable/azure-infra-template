...
Directory prefixes used in this repo map roughly as: `00-*` foundation/network, `05-*` secrets, `06-*` configuration, `10-*` edge, `20-*` data, `25-*` utility access, `30-*` compute, `40-*` observability.
